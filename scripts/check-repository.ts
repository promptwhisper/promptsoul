...
const requiredFiles = [
  ...
  "lib/server/aivis-cache.ts",
  "lib/server/aivis-client.ts",
  "lib/server/aivis-service.ts",
  "lib/server/aivis-types.ts",
  "lib/shared/browser-tts.ts",
  "scripts/record-browser.ts",
  "scripts/tts-check.ts",
  "scripts/tts-smoke.ts",
  "tools/record_browser.sh",
] as const;
